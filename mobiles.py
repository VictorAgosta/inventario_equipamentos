...
def cadastro_mobile(cod_mob, obj_mob):
    ...
    lb0 = Label(app3, text='Código Mobile', background='Silver', foreground='black', anchor=W)
    lb0.place(x=10, y=30, height=20, width=100)

    nome_mobile = Label(app3, text=f'{cod_mob}', background='Silver', foreground='black', anchor=W)
    nome_mobile.place(x=120, y=30, height=20, width=350)

    # nome mobile:
    lb1 = Label(app3, text='Equipamento:', background='Silver', foreground='black', anchor=W)
    ...
    # marca
    lb2 = Label(app3, text='Marca:', background='Silver', foreground='black', anchor=W)
    lb2.place(x=10, y=90, height=20, width=100)

    marca_mobile = Entry(app3)
    marca_mobile.place(x=120, y=90, height=20, width=350)

    # modelo
    lb3 = Label(app3, text='Modelo:', background='Silver', foreground='black', anchor=W)
    lb3.place(x=10, y=120, height=20, width=100)

    modelo_mobile = Entry(app3)
    modelo_mobile.place(x=120, y=120, height=20, width=350)

    # cod_chip
    lb4 = Label(app3, text='Código do Chip:', background='Silver', foreground='black', anchor=W)
    lb4.place(x=10, y=150, height=20, width=100)

    cod_chip_mobile = Entry(app3)
    cod_chip_mobile.place(x=120, y=150, height=20, width=350)

    # numero chip
    lb7 = Label(app3, text='Número do Chip:', background='Silver', foreground='black', anchor=W)
    lb7.place(x=10, y=210, height=20, width=100)
    ...
    def comando_btn31():
        ...
        lb5.configure(text=hist, background='Black', foreground='white')
    ...
    btn31.place(x=100, y=170, height=40, width=150)

    lb5 = Label(app3, text=' ', background='Silver', foreground='black', anchor=W)
    lb5.place(x=50, y=250, height=40, width=400)
    ...
    btn32.place(x=50, y=350, height=40, width=150)

    btn33 = Button(app3, text='Apagar', command=msg_erro_apagar)
    btn33.place(x=275, y=350, height=40, width=150)
    ...
    btn34 = Button(app3, text='Atualizar CHIP', command=comando_btn34)
    btn34.place(x=300, y=350, height=40, width=150)
